...
if __name__=="__main__":
    ...
    dataset=CamDataset(cam_size=20)
    L=len(dataset)
    for i in range(opt.max_iter):
        ...
        if i%500==0:
            ...
            cv2.imwrite(f"./result/img/{i:03d}.png",img)
            ...
            mesh.export(os.path.join("./result/mesh", f'{i:03d}.ply'))
        if i%3000==0:
            torch.save(sdf_network.state_dict(),f"./saved_model/{i:05d}_sdf.pth")
            torch.save(color_network.state_dict(),f"./saved_model/{i:05d}_color.pth")
